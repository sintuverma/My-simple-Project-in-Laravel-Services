...
<footer>
 ...
 <!-- end footer -->
 <!-- Javascript files-->
 <script src="{{url('frontend_files/js/jquery.min.js')}}"></script>
 <script src="{{url('frontend_files/js/bootstrap.bundle.min.js')}}"></script>
 <script src="{{url('frontend_files/js/jquery-3.0.0.min.js')}}"></script>
 <!-- sidebar -->
 <script src="{{url('frontend_files/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
 <script src="{{url('frontend_files/js/custom.js')}}"></script>
</body>
</html>
